...
\begin{table}[!t]
    ...
    \begin{tabular}{lcc}
    \hline
    \multirow{2}{*}{Function}&\multicolumn{2}{c}{Number of ASM instructions} \\
    &C&SPARK\\ \hline
    \spark{TCP_Listen}   & 18                  & 11                   \\
    \spark{TCP_Accept}   & 153                 & 167                  \\
    \spark{TCP_Connect}  & 103                 & 114                  \\
    \spark{TCP_Send}     & 94                  & 124                  \\
    \spark{TCP_Receive}  & 113                 & 153                  \\
    \spark{TCP_Shutdown} & 107                 & 122                  \\
    \spark{TCP_Abort}    & 42                  & 50                   \\ \hline
    \end{tabular}
\end{table}
