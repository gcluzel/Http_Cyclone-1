...
\begin{table}[!t]
    \caption{Comparison of the number of ASM instructions between the C and the SPARK implementation}
    \label{table:instr}
    \renewcommand{\arraystretch}{1.3}
    \centering
    \begin{tabular}{lccc}
    \hline
    \multirow{2}{*}{Function}&\multicolumn{2}{c}{Number of ASM instructions}&\multirow{2}{*}{$\Delta$ num. of instr.} \\
    &C&SPARK & \\ \hline
    \spark{TCP_Listen}   & 18 & 11                   & $-$39\%\\
    \spark{TCP_Accept}   & 153 & 167                  & +9\%\\
    \spark{TCP_Connect}  & 103 & 114                  & +10\%\\
    \spark{TCP_Send}     & 94 & 124                  & +31\%\\
    \spark{TCP_Receive}  & 113 & 153                  & +35\%\\
    \spark{TCP_Shutdown} & 107 & 122                  & +14\%\\
    \spark{TCP_Abort}    & 42 & 50                   & +19\%\\ \hline
    \end{tabular}
\end{table}
