...
\todo[inline]{Is this part good enough or does it need to be rewritten?}

The soundness of our verificatin requires all the contracts to be correct, in particular this is true for the contract of \spark{TCP_Process_One_Segment}.
Get this contract can be done by rewriting in SPARK the part that processes the
