...
In the above scenario the post-condition of  \spark{Socket_Connect} will set the value of \spark{Sock.S_Remote_Ip_Addr} if the function succesfully executes, and thus, \spark{Error} is not equal to \spark{NO_ERROR}. In the case an error occurs, \spark{Sock.S_Remote_Ip_Addr} won't be initialized, and thus, the function \spark{Socket_Send} cannot be called because its precondition wont be satisfied.
